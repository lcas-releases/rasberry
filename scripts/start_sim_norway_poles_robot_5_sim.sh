...
tmux send-keys "DISPLAY=:$DISPLAY roslaunch rasberry_bringup robot_bringup.launch robot_model:=$(rospack find rasberry_bringup)/config/norway_robot_005.yaml model_extras:=$(rospack find rasberry_bringup)/urdf/norway_robot_005_sensors.xacro simple_sim:=true world_name:=norway_poles with_actors:=false"
...
tmux send-keys "DISPLAY=:$DISPLAY roslaunch rasberry_coordination robot_websocket_adapter.launch robot_name:=thorvald_005 rosbridge_ip:=10.8.0.4 rosbridge_port:=9090"
